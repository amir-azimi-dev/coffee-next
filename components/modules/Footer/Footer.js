...
import { faEnvelope, faMapMarkedAlt, faPhoneAlt, faX } from "@fortawesome/free-solid-svg-icons";
    ...
    <div className="container-fluid footer text-white mt-5 pt-5 px-0 position-relative overlay-top">
      <div className="row mx-0 pt-5 px-sm-3 px-lg-5 mt-4">
        <div className="col-lg-3 col-md-6 mb-5">
          ...
          <p><FontAwesomeIcon icon={faMapMarkedAlt} className="mr-2" />123 Street, New York, USA</p>
        ...
        <div className="col-lg-3 col-md-6 mb-5">
          ...
          <div className="d-flex justify-content-start">
            <a className="btn btn-lg btn-outline-light btn-lg-square mr-2" href="#"><FontAwesomeIcon icon={faX} /></a>
            <a className="btn btn-lg btn-outline-light btn-lg-square mr-2" href="#"><FontAwesomeIcon icon={faX} /></a>
            <a className="btn btn-lg btn-outline-light btn-lg-square mr-2" href="#"><FontAwesomeIcon icon={faX} /></a>
            <a className="btn btn-lg btn-outline-light btn-lg-square mr-2" href="#"><FontAwesomeIcon icon={faX} /></a>
          </div>
      ...
      <div className="container-fluid text-center text-white border-top mt-4 py-4 px-sm-3 px-md-5" style={{ borderColor: "rgba(256, 256, 256, .1) !important" }}>
        <p className="mb-2 text-white">Copyright &copy;
          <a className="font-weight-bold" href="#">Domain</a>. All Rights Reserved.
        </p>
